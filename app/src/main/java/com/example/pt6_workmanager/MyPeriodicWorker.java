...
public class MyPeriodicWorker extends Worker {
    ...
    public Result doWork() {
        displayNotification("Set up","Task to Do: Catch a Moment!");
    ...
    private void displayNotification(String task, String desc) {
        ...
        NotificationChannel channel = new NotificationChannel("1918057",
                "jennie", NotificationManager.IMPORTANCE_HIGH);
